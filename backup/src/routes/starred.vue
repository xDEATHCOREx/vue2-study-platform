...
<div>
 ...
 <mu-tabs :value="activeTab" @change="handleTabChange">
  <mu-tab class="starred-tab" value="tab1" icon="help" title="问题" @click.once="getStarred(2)"/>
  <mu-tab class="starred-tab" value="tab2" icon="library_books" title="课程" @click.once="getStarred(1)"/>
</mu-tabs>
